...
int main() //to start the code
{
    ...
    cout << "#" << setfill (' ') << setw(80) << "#"<< endl; //changes it to a space instead of #
    cout <<"# Ways to access the Task Manager on your Windows computer:" << setw(22)<< "#" << endl;  // first line
    cout <<"#" << setw(80) << "#" << endl;  // spaces for box
    cout <<"#       Press the key combination Ctrl + Shift + Escape" << setw(26) << "#"<< endl; // changed the extra spaces into setw too
    cout <<"#" << setw(80) << "#" << endl;  // spaces for box
